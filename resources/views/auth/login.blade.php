			        ...
			        <div class="auth-form-container text-start">
						<form class="auth-form login-form" method="POST" action="{{ route('login') }}">     
							...
							<div class="email mb-3">
								...
								<input id="signin-email" type="email" name="email" class="form-control signin-email @error('email') is-invalid @enderror" placeholder="Email address" required="required" value="{{old('email')}}">
                                @error('email')
							...
							<div class="password mb-3">
								...
								<input id="signin-password" type="password" name="password" class="form-control signin-password @error('password') is-invalid @enderror" placeholder="Password" required="required">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
